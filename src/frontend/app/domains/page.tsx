    ...
    <div className="min-h-screen bg-surface-0">
      ...
      <nav className="flex items-center justify-between px-6 py-4 border-b border-border-subtle">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/lessons" className="text-sm text-text-secondary hover:text-text-primary transition-colors">
            Lessons
          </Link>
          <Link href="/dashboard" className="text-sm text-text-secondary hover:text-text-primary transition-colors">
            Dashboard
          </Link>
          <Link href="/domains" className="text-sm text-accent font-medium">
            Domains
          </Link>
        </div>
      </nav>
      ...
      {/* Footer */}
      <footer className="border-t border-border-subtle px-6 py-4 mt-10">
