  ...
  return (
    <div className="min-h-screen flex flex-col bg-surface-0">
      ...
      <main id="main-content" className="flex-1 flex flex-col">
        <section aria-labelledby="hero-heading" className="px-6 pt-20 pb-16 md:pt-28 md:pb-20">
          <div className="max-w-[1000px] mx-auto text-center">
            <SkillGraphVisual />

            <h1 id="hero-heading" className="mt-6 text-5xl md:text-6xl font-heading text-text-primary tracking-tight leading-[1.1]">
              Teaching, reasoned.
            </h1>
        ...
        <section aria-labelledby="features-heading" className="px-6 py-16 md:py-24">
          <h2 id="features-heading" className="sr-only">What makes this different</h2>
        ...
        {/* See it in action */}
        <section aria-labelledby="demos-heading" className="px-6 py-16 md:py-20">
          <div className="max-w-5xl mx-auto">
            <h2 id="demos-heading" className="text-3xl md:text-4xl font-heading text-text-primary text-center mb-12">
              See it in action
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              >
                <div className="w-10 h-10 rounded-lg bg-bloom-evaluate/15 flex items-center justify-center mb-3" aria-hidden="true">
                  <svg className="w-5 h-5 text-bloom-evaluate" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
              ...
              >
                <div className="w-10 h-10 rounded-lg bg-bloom-create/15 flex items-center justify-center mb-3" aria-hidden="true">
                  <svg className="w-5 h-5 text-bloom-create" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
              ...
              >
                <div className="w-10 h-10 rounded-lg bg-bloom-understand/15 flex items-center justify-center mb-3" aria-hidden="true">
                  <svg className="w-5 h-5 text-bloom-understand" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
              ...
              >
                <div className="w-10 h-10 rounded-lg bg-bloom-analyze/15 flex items-center justify-center mb-3" aria-hidden="true">
                  <svg className="w-5 h-5 text-bloom-analyze" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
