...
export const rosterAgent: AgentDefinition = {
  description:
    "Manages groups of learners — aggregates skill profiles, identifies common gaps, recommends pairings, and surfaces group-level patterns. Delegate to when the educator needs insight about their group as a whole.",
  model: "sonnet",
  tools: [
    "Read",
    "Glob",
  ...
  prompt: `You are a roster management specialist. Your job is to reason about groups
